...
SUPABASE_URL = os.environ.get("SUPABASE_URL", "https://aymygtjocnhikzmtcmtj.supabase.co").strip()
SUPABASE_KEY = os.environ.get("SUPABASE_KEY", "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImF5bXlndGpvY25oaWt6bXRjbXRqIiwicm9sZSI6ImFub24iLCJpYXQiOjE3ODEyODUxNjEsImV4cCI6MjA5Njg2MTE2MX0.pBTdtcWBKxv0lx8lytGUrGF9YXwQCawKXdyvqeXndjU").strip()
